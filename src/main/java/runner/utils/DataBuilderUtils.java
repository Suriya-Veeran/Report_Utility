...
public class DataBuilderUtils {
  ...
  public static String buildObjectiveDescription(ReportNameConstants type) {
    switch (Objects.requireNonNull(type)) {
      case MATERIALIZED_VIEW_REFRESH_REPORT:
        return "The materialised view after being created once, needs to be refreshed at intervals "
      ...
      case PURGE_REPORT:
        return "The purge report use case involves identifying and removing outdated or irrelevant data from the system to maintain database "
