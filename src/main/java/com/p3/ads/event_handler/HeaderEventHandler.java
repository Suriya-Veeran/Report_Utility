package com.p3.ads.event_handler;
...
import static com.p3.ads.utils.ImageUtils.loadImage;
...
// Skip header for first page
            if (pageNumber != 1) {
                document.setMargins(65, 36, 36, 36); // top, right, bottom, left
            }
            canvas.add(new Paragraph()
                    .setMargin(2).setPadding(0).add(lineSeparator));
            canvas.close();
